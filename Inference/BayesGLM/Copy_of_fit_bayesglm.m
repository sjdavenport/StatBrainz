function [INLA_model_obj, field_estimates, hyperpar_posteriors] = fit_bayesglm(BOLD, design, nuisance, spatial, ...
    ...
    meanTol, varTol)
% FIT_BAYESGLM fits a (optionally Bayesian) GLM to fMRI BOLD data using
% INLA for spatial smoothing of the activation coefficients.
%--------------------------------------------------------------------------
% ARGUMENTS
% Mandatory
...
%  Bayes         logical flag; if true run Bayesian GLM via INLA (default: true)

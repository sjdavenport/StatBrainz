...
%% 3D: fast_conv vs SPM vs convfield
Dim = [50,50,50]; FWHM = 3; lat_data = normrnd(0,1,Dim); halfDim = Dim(1)/2;
D = length(Dim);
...
%% Compare speed to spm_smooth (fast_conv is much faster)
